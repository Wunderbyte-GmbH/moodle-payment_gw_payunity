...
/**
 * Class paygw_payunity_generator for generation of dummy data
 *
 ...
 */
class paygw_payunity_generator extends testing_module_generator {
    ...
    /**
     * Function to create a dummy PayUnion payment gateway configuration.
     *
